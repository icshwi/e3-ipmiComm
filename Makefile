...
# Date    : Monday, November 20 17:15:31 CET 2017
# version : 0.0.1
#
# template file is generated by prepare_module.bash with a32d451e2271765de642e59313a383247d825d34
#
...
epics:
	...
	$(QUIET)echo "IOCADMIN=$(M_IOCSTATS)"              >> $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/RELEASE
	$(QUIET)echo "EPICS_BASE=$(COMMUNITY_EPICS_BASE)"  >> $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/RELEASE
	$(QUIET)echo "INSTALL_LOCATION=$(M_IPMICOMM)"       > $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/CONFIG_SITE	
